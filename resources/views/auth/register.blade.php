...
@section('content')
    ...
    <p class="text-secondary">Already have an account? <a class="text-success" href="{{ route('patient-login') }}">Log-in</a></p>

    <button class="btn btn-primary btn-lg btn-block btn-success" type="submit">Register</button>

    <hr class="my-4">
    <div class="copyright text-secondary text-center">
        &copy; <span class="current-year"></span><span class="text-bold text-uppercase"> EHR</span>. <span>All rights reserved</span>
    </div>
