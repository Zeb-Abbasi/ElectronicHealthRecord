...
@section('content')
    <div class="container-fluid mt-5">
        <a href="{{ route('doctors.create') }}"><button class="btn btn-success">Add Doctor</button></a>
                    ...
                    @foreach ($doctors as $doctor)
                        <tr>
                            ...
                            <td>
                                ...
                                <form id="deleteForm" method="POST" action="{{ route('doctors.delete', ['id' => $doctor->id]) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="p-0 border-0" data-bs-toggle="modal" data-bs-target="#deleteModal">
